...
function buildNavSections(settingsChildren: NavItem[]): NavSection[] {
  return [
    ...
    { title: 'AGENTE', items: [
      ...
      { to: '/agente/configuracao-avancada', icon: SlidersHorizontal, label: 'Configuração avançada', permission: 'managePlatform', roles: ['owner', 'admin', 'supervisor'] },
      { to: '/agente/aprendizado', icon: GraduationCap, label: 'Aprendizado', permission: 'managePlatform', roles: ['owner', 'admin', 'supervisor'] },
      { to: '/agente/execucoes', icon: Activity, label: 'Execuções e logs', permission: 'managePlatform', roles: ['owner', 'admin', 'supervisor'] },
    ] },
    { title: 'GESTÃO', items: [
