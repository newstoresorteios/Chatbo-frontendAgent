...
export const mockConversationAgentContext: Record<string, ConversationAgentContext> = {
  c1: {
    conversationId: 'c1',
    senderKey: '5511999990001',
    contact: {
      id: 1,
      identityKey: 'wa:5511999990001',
      senderKey: '5511999990001',
      senderPhone: '5511999990001',
      senderName: 'Carlos Mendes',
      marketingStatus: 'eligible',
      messagingWindowExpiresAt: new Date(Date.now() + 18 * 3600000).toISOString(),
      channel: 'whatsapp',
    },
    status: {
      id: 10,
      status: 'active',
      stage: 'cart',
      productName: 'Kit XT-200 (50 un.)',
      cartUrl: 'https://loja.exemplo.com/cart/demo',
      paymentUrl: 'https://loja.exemplo.com/pay/demo',
      orderId: null,
      lastCustomerMessageAt: new Date(Date.now() - 120000).toISOString(),
      nextScheduledAt: new Date(Date.now() + 2 * 3600000).toISOString(),
    },
    memories: [
      {
        id: 1,
        ...
        safeSummary: 'Prefere ser chamado de Carlos',
        importance: 0.8,
        status: 'active',
      ...
      },
      {
        ...
        memoryKey: 'budget',
        memoryKind: 'commerce',
        safeSummary: 'Orçamento aproximado de R$ 15 mil',
        importance: 0.7,
        status: 'active',
      },
    ],
    ...
    recentResponses: [
      {
        id: 101,
        replyText: 'Separei o orçamento das 50 unidades do XT-200. Posso enviar o link do carrinho?',
      ...
      {
        id: 100,
        replyText: 'Entendi — vou verificar disponibilidade e te retorno com valores.',
  ...
  c3: {
    ...
    status: {
      ...
      productName: 'Pedido #4521',
      paymentUrl: 'https://loja.exemplo.com/pay/4521',
      orderId: '4521',
      lastCustomerMessageAt: new Date(Date.now() - 7200000).toISOString(),
    },
    memories: [],
    pixPayments: [
      {
    ...
    recentResponses: [
      {
        id: 201,
        replyText: 'Seu pedido #4521 está aguardando confirmação do PIX.',
