...
export function PersonaUpsellForm({
  ...
  return (
    <div className="space-y-4">
      ...
      <ListEditor label="Regras de recomendação" values={value.recommendationRules ?? []} onChange={(recommendationRules) => onChange({ ...value, recommendationRules, upsellRules: recommendationRules })} disabled={disabled} />
    </div>
  );
}
